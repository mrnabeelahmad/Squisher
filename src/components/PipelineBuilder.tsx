    ...
    <div id="pipeline-builder-container" className="bg-slate-900/50 backdrop-blur-md rounded-2xl border border-slate-800/80 shadow-[0_4px_24px_rgba(0,0,0,0.5)] p-6 flex flex-col h-full">
      <div className="flex items-center justify-between mb-4 pb-4 border-b border-slate-800">
        ...
        <div className="flex gap-1.5 items-center">
          {onResetAll && (
            <button
              id="reset-images-tool-btn"
              onClick={onResetAll}
              className="text-[11px] font-semibold text-rose-400 hover:text-rose-300 transition flex items-center gap-1 bg-rose-955/20 hover:bg-rose-950/40 px-2 md:px-2.5 py-1.5 rounded-lg border border-rose-900/40 cursor-pointer"
          ...
          {steps.length > 0 && (
            <button
              ...
              onClick={() => setSteps([])}
              className="text-[11px] font-semibold text-slate-400 hover:text-white transition flex items-center gap-1 bg-slate-950 hover:bg-slate-900 px-2 md:px-2.5 py-1.5 rounded-lg border border-slate-800 cursor-pointer"
            >
      ...
      <div id="add-step-triggers" className="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4">
        {[
